...
export default function TagihanUktEdit({ tagihanUkt, mahasiswas, academicYearSemesters, uktSchemes }: Props) {
    const { data, setData, put, processing, errors } = useForm({
        mahasiswa_id: tagihanUkt.mahasiswa_id.toString(),
        academic_year_semester_id: tagihanUkt.academic_year_semester_id.toString(),
        ...
        <>
            ...
            <div className="space-y-6">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold">Edit Tagihan UKT</h1>
                        <p className="text-muted-foreground">Perbarui data tagihan UKT</p>
                    </div>
                </div>
                ...
                <Card>
                    <CardHeader>
                        ...
                        <CardDescription>Perbarui data tagihan uang kuliah tunggal</CardDescription>
                    </CardHeader>
                    <CardContent>
