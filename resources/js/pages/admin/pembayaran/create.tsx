...
export default function PembayaranCreate({ tagihanUkts }: Props) {
    ...
    const selectedTagihan = useMemo(
        () =>
            tagihanUkts.find((t) => t.id.toString() === data.tagihan_ukt_id) ||
            null,
                ...
                <div className="flex items-center justify-between">
                    <div>
                        ...
                        <p className="text-gray-600">
                            Untuk pembayaran tunai/manual di kantor — otomatis
                    ...
                    <Card className="border border-gray-200 shadow-sm">
                        ...
                        <CardContent className="space-y-6">
                            <div className="space-y-2">
                                ...
                                <Select
                                    value={data.tagihan_ukt_id}
                                    onValueChange={(value) =>
                                        setData('tagihan_ukt_id', value)
                                    }
                                >
                                ...
                                {selectedTagihan && (
                                    <p className="text-xs text-gray-500">
                                        Sisa tagihan:{' '}
                                        {formatCurrency(
                                            selectedTagihan.jumlah_tagihan -
                                                selectedTagihan.jumlah_bayar,
                                        )}
                                    </p>
                                )}
                            </div>
