                            ...
                            {dosens.data.length === 0 ? (
                                ...
                                dosens.data.map((dosen) => (
                                    <TableRow key={dosen.id}>
                                        ...
                                        <TableCell>{dosen.program_studi?.nama_prodi}</TableCell>
                                        <TableCell>{dosen.pendidikan_terakhir}</TableCell>
                                        <TableCell>
                                        ...
                                        <TableCell className="text-right">
                                            <div className="flex items-center justify-end gap-2">
                                                <Link href={`/admin/dosen/${dosen.uuid}`}>
                                                ...
                                                <AlertDialog>
                                                    ...
                                                    <AlertDialogContent>
                                                        ...
                                                        <AlertDialogFooter>
                                                            ...
                                                            <AlertDialogAction
                                                                onClick={() => handleDelete(dosen.uuid)}
                ...
                {dosens.last_page > 1 && (
                    <div className="flex items-center justify-between">
                        ...
                        <div className="flex items-center gap-2">
                            {Array.from({ length: dosens.last_page }, (_, i) => i + 1).map(
                                (page) => (
                                    <Button
                                        key={page}
