...
export default function KrsCreate({ mahasiswas, kelases, academicYearSemesters }: Props) {
        ...
        <>
            ...
            <div className="space-y-6">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold">Tambah KRS</h1>
                        <p className="text-muted-foreground">Tambahkan Kartu Rencana Studi baru</p>
                    </div>
                </div>
                ...
                <Card>
                    <CardHeader>
                        ...
                        <CardDescription>Isi data KRS mahasiswa</CardDescription>
                    </CardHeader>
                    <CardContent>
