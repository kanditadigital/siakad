...
export default function TendikCreate() {
        ...
        <>
            ...
            <div className="space-y-6">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold">Tambah Tendik</h1>
                        <p className="text-muted-foreground">
                            Isi form berikut untuk menambahkan tenaga kependidikan baru
                        </p>
                    </div>
                </div>
...
TendikCreate.layout = (page: React.ReactNode) => (
