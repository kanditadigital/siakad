        ...
        <>
            ...
            <div className="space-y-6">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold">Tambah Yudisium</h1>
                        <p className="text-muted-foreground">Input data yudisium mahasiswa</p>
                    </div>
                </div>
                ...
                <Card>
                    <CardHeader>
                        ...
                        <CardDescription>Isi data yudisium mahasiswa</CardDescription>
                    </CardHeader>
                    <CardContent>
