        ...
        <>
            ...
            <div className="space-y-6">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold">Edit Skema UKT</h1>
                        <p className="text-muted-foreground">Perbarui data skema UKT {uktScheme.nama}</p>
                    </div>
                </div>
                ...
                <Card>
                    <CardHeader>
                        ...
                        <CardDescription>Perbarui data skema uang kuliah tunggal</CardDescription>
                    </CardHeader>
                    <CardContent>
