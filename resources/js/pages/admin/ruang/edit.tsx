        ...
        <>
            ...
            <div className="space-y-6">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold">Edit Ruang</h1>
                        <p className="text-muted-foreground">Perbarui data ruang {ruang.nama_ruang}</p>
                    </div>
                </div>
                ...
                <Card>
                    <CardHeader>
                        ...
                        <CardDescription>Perbarui data ruang kelas</CardDescription>
                    </CardHeader>
                    <CardContent>
