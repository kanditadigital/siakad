    ...
    return (
        <>
            ...
            <div className="space-y-6">
                <div>
                    <h1 className="text-2xl font-bold text-green-800">Tambah Mahasiswa</h1>
                    <p className="text-gray-600">Isi form berikut untuk menambahkan mahasiswa baru</p>
                </div>
                    ...
                    <Card className="border border-gray-200 shadow-sm">
                        ...
                        <CardContent>
                            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                                ...
                                <div className="space-y-2">
                                    <Label className="text-gray-700">NIM (Otomatis)</Label>
