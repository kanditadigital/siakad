...
export default function MahasiswaIndex({ mahasiswas, programStudis, filters }: Props) {
        ...
        <>
            ...
            <div className="space-y-6">
                ...
                <div className="flex flex-wrap items-center gap-4">
                    ...
                    <Select value={prodiFilter} onValueChange={handleProdiChange}>
                                    ...
                                    <TableRow key={mhs.id}>
                                        ...
                                        <TableCell className="text-right">
                                            <div className="flex items-center justify-end gap-2">
                                                <Link href={`/admin/mahasiswa/${mhs.uuid}`}>
                                                    <Button variant="ghost" size="icon">
                                                        <Eye className="h-4 w-4" />
                                                    </Button>
                                                </Link>
                                                <Link href={`/admin/mahasiswa/${mhs.uuid}/edit`}>
                                                    <Button variant="ghost" size="icon">
                                                ...
                                                <AlertDialog>
                                                    ...
                                                    <AlertDialogContent>
                                                        <AlertDialogHeader>
                                                            ...
                                                            <AlertDialogDescription>
                                                                Apakah anda yakin ingin menghapus mahasiswa {mhs.nama}?
                                                            </AlertDialogDescription>
                                                        </AlertDialogHeader>
                                                        <AlertDialogFooter>
                                                            <AlertDialogCancel>Batal</AlertDialogCancel>
                                                            <AlertDialogAction
                                                                onClick={() => handleDelete(mhs.uuid)}
                ...
                {mahasiswas.last_page > 1 && (
                    <div className="flex items-center justify-between">
                        ...
                        <div className="flex items-center gap-2">
                            {Array.from({ length: mahasiswas.last_page }, (_, i) => i + 1).map(
                                (page) => (
                                    <Button
                                        key={page}
