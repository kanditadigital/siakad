...
type MataKuliah = {
    ...
    sks: number;
    semester: number;
    prasyarat_mata_kuliah_id: number | null;
    status: string;
...
export default function MataKuliahEdit({ mataKuliah, mataKuliahs }: Props) {
    const { data, setData, put, processing, errors } = useForm({
        ...
        prasyarat_mata_kuliah_id:
            mataKuliah.prasyarat_mata_kuliah_id?.toString() || '',
        status: mataKuliah.status,
    });

    const handleSubmit = (e: React.FormEvent) => {
        e.preventDefault();
        put(`/admin-prodi/mata-kuliah/${mataKuliah.uuid}`);
    };
        ...
        <>
            ...
            <div className="space-y-6">
                <div className="flex items-center gap-4">
                    <Link href="/admin-prodi/mata-kuliah">
