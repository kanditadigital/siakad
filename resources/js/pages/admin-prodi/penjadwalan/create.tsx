...
type Props = {
    ...
    activeAcademicYearSemesterId: number | null;
};
...
export default function PenjadwalanCreate({
    ...
    const { data, setData, post, processing, errors } = useForm({
        ...
        kapasitas: '',
        semester: '',
        academic_year_semester_id: activeAcademicYearSemesterId
            ? activeAcademicYearSemesterId.toString()
            : '',
        status: 'Aktif',
    });
    ...
    const filteredMataKuliahs = useMemo(() => {
    ...
    const filteredDosens = useMemo(() => {
        ...
        return dosens.filter((d) => d.nama.toLowerCase().includes(q));
    }, [dosens, dosenSearch]);

    const handleSubmit = (e: React.FormEvent) => {
        e.preventDefault();
        post('/admin-prodi/penjadwalan');
    };
        ...
        <>
            ...
            <div className="space-y-6">
                <div className="flex items-center gap-4">
                    <Link href="/admin-prodi/penjadwalan">
